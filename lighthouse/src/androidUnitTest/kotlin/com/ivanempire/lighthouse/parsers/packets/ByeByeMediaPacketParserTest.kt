...
class ByeByeMediaPacketParserTest {
    ...
    object Fixtures {
        ...
        val VALID_BYEBYE_PACKET_HEADER_SET_3 = hashMapOf(
            ...
            HeaderKeys.NOTIFICATION_SUBTYPE to "ssdp:byebye",
            HeaderKeys.UNIQUE_SERVICE_NAME to "uuid:00000000-0000-0000-0000-000000000000::urn:upnp-org:serviceId:SwitchPower.0001::urn:schemas-upnp-org:service:SwitchPower:1",
