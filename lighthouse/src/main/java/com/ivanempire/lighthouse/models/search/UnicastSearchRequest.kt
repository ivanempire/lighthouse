...
/**
 * A unicast [SearchRequest] that will send the search data to a specific IP address on the network.
 * This can be used to quickly confirm the existence of a device and get additional information
 * about it like the UUID, XML endpoint, embedded components.
 *
