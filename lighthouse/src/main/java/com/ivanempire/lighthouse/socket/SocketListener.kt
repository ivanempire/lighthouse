...
internal interface SocketListener {
     ...
     * network discovery. A new socket is created, the multicast lock is acquired, and the multicast
     * group is joined
     *
     ...
     * Lighthouse will release the multicast lock, leave the multicast group, and make sure that the
