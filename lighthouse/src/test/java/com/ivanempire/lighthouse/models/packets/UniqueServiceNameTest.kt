...
class UniqueServiceNameTest {
    ...
    fun `given embedded service USN correctly parses`() {
        val usnStringService1 =
            "uuid:709e1cf4-920d-4aa7-8678-6dab1b6c68a9::urn:schemas-upnp-org:service:Dimming:1"
        assertEquals(
            EmbeddedService("709e1cf4-920d-4aa7-8678-6dab1b6c68a9", "Dimming", "1"),
            UniqueServiceName(usnStringService1),
        )

        val usnStringService2 =
            "uuid:709e1cf4-920d-4aa7-8678-6dab1b6c68a9::urn:schemas-upnp-org:service:SwitchPower:1"
        assertEquals(
    ...
    fun `given embedded device USN correctly parses`() {
        val usnStringDevice =
            "uuid:709e1cf4-920d-4aa7-8678-6dab1b6c68a9::urn:schemas-upnp-org:device:DimmableLight:1"
        assertEquals(
    ...
    fun `given complex USN 1 correctly parses`() {
        val usnString =
            "uuid:ebf5a0a0-1dd1-11b2-a90f-e0dbd1eb5ad2::urn:schemas-upnp-org:service:DiscoverFriendlies:1"
        assertEquals(
            EmbeddedService(
    ...
    fun `given complex USN 2 correctly parses`() {
        val usnString =
            "uuid:5f6085cb-5c18-40c6-a299-dbc05135b0c4::urn:samsung.com:service:ScreenSharingService:1"
        assertEquals(
            EmbeddedService(
    ...
    fun `given USN for Amcrest camera correctly parses`() {
        val usnString =
            "uuid:device_3_0-AMC066F0BC0A3747AF::urn:schemas-upnp-org:device:3.0-AMC066F0BC0A3747AF"
        assertEquals(
